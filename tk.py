...
screen = pg.display.set_mode((width,height+100), 0, 32)
 # game window 
pg.display.set_caption("ITS ANKY'S TiC tAc TOe")
# loading the img as python objects
initiating_window = pg.image.load("py.png")
